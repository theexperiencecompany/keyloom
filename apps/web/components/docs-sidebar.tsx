...
// Docs navigation rail for the (shell) route group. This is a separate tree
// from components/app-sidebar.tsx, which is the studio/dashboard nav — the two
// share a shape but list entirely different destinations.
